			...
			<Container>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10'>
					...
					<div className='space-y-3'>
						...
						<p>
							Phòng 102, Tòa nhà 20-20B Trần Cao Vân, Phường Đa Kao, Quận 1, TP.
							Hồ Chí Minh
						</p>
						<p>
						...
						<p>
							Giấy phép hoạt động dịch vụ việc làm số: 28937/2024/SLĐTBXH-VLATLĐ
							do Sở Lao Động Thương Binh và Xã Hội cấp ngày 18/11/2024
						</p>
