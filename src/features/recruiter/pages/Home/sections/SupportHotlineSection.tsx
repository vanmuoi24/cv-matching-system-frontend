			...
			<Container>
				<div className='flex flex-col md:flex-row'>
					...
					<div className='flex-1 flex flex-col items-center text-center px-4 mb-8 md:mb-0 md:border-r border-gray-200'>
						...
						<button className='px-6 py-2 border border-[#361d5e] text-[#361d5e] font-medium rounded hover:bg-[#361d5e] cursor-pointer hover:text-white transition-colors duration-300'>
					...
					<div className='flex-1 flex flex-col items-center text-center px-4'>
						...
						<button className='px-6 py-2 border border-blue-500 text-blue-500 font-medium rounded hover:bg-blue-500 cursor-pointer hover:text-white transition-colors duration-300'>
