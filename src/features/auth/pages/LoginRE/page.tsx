			...
			<div className='bg-white p-8 rounded-xl shadow-md w-[450px]  border border-gray-100'>
				...
				>
					...
					<Form.Item className='mb-3!'>
						<button className='w-full transition duration-300 text-white cursor-pointer hover:bg-[#2e068b] border-none rounded-md text-base font-semibold! bg-[#542ab6] py-2'>
							Đăng nhập
						</button>
					</Form.Item>
				</Form>
